...
Cr=OutlierRemoval(Cr,'riemann','riemann');
...
load('Variables/ClassMeanOutlier.mat');             %From Algorithm 1,2 the centers of the outlier removed signal
...
Krn=Prediction(SimpleCenter,Cr,'riemann');                    %Predictions, of raw data
